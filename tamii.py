...
cl = LINETCR.LINE()
cl.login(token="Es3ACRRkuyrGZ0mhu7Yf.r5RawF4wXYQhVUlqKb6mpW.CezvrwDXuptxH6L55hW93X//bWuDrirce1raHAakq/A=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Esed5PkNPwfxHWCsqgWf.+ABCeSB6EIds4PgV4UGaRW.b34fUxgZkGWQ1q1oQbfy4mzB3A5/iz01JjyM/1fJrAk=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EsAP1ivSUlZVdA7xr0Le.VCIFlyVTogKKOPyvujzLZG.CRRKPAWHvRD3Q24q7Op80rlgLW0oRvdDJ6yfEiyDOe8=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EsmYiX9n4R1bJjPrV5na.YrEUBEmpSvXbOCVw0GLL6G.6zJLxWR8G6p7HY8GLZk9LAjYd9clPEbn7VEKIwJDX7A=")
kc.loginResult()

kd = LINETCR.LINE()
kd.login(token="EsDnJevdZrF4DCz9YAqf.4LRv3gA1twqOkp10kfgD7W.y0uEL9c92Dh1bPKoYT5hRChUK9KJDMmylJtdBTn7r4c=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="Es6B1Fqp87syQXXaATH7.7v0zhfadF6oxy23AresKTW.3qJLxG8lPAo7DqGrZ+CFW8LebB2iGzHWERqdMKIy9JE=")
ke.loginResult()

kf = LINETCR.LINE()
kf.login(token="Es9SRHJmYt9LdjZ9j4qf.LGnoT03lEI30qSv9bhbBBW.I/S158XhUi0jCZbI4sEi2443rQnIQzBWo5XyMmpGPnY=")
kf.loginResult()

kg = LINETCR.LINE()
kg.login(token="EsSghyNviarS0pBnwGr0.Nj1Ll0Q8XdFuE/0FIRRema.VcjxGlWvwdVQPbUBqkf3sBotcJrkF1E76ewAbsGJtgw=")
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token="Es9zB1IFYvYbDMeWxPZ9.TbCnuFiYBP+U5dZdspjH/q.4i9xg6HWuFoO0wCnqVyJkabpdVQ+hSBOyNIZNRLiWeQ=")
kh.loginResult()

kj = LINETCR.LINE()
kj.login(token="EsoQnz1IdouBojrNeCy4.8NaIvlVRBSw74cWPQHDi5a.fYIwe9jKJLC1uFP+44+GPcZcBYDoQ7l33/ZPLj7KUPQ=")
kj.loginResult()

kl = LINETCR.LINE()
kl.login(token="Es7u7DBxTE47B3JSoJU3.oQJ6yGf4n4CraLU/jIDuCW.XEcCDmhFuAOjRwS8xJiBRv7T9uDj9e8UqjI0aUEPqQU=")
kl.loginResult()

km = LINETCR.LINE()
km.login(token="EsvLFW6ElMXhU8X60vWb.2Q5r7z+QXn1PKHWV05c8YW.PJR3Dz8LQBiFsLdEAG9AkR+G8fwf7EuHuQreIAz3Q50=")
km.loginResult()

kn = LINETCR.LINE()
kn.login(token="Es97Ib5Jm9HmykeALU4c.fkZwkTenli7EefqhiG1cla.p/A3FVpm/74KQAZtucTjeQGEPpSkcBrK0DJ+MUIVgyw=")
kn.loginResult()

ko = LINETCR.LINE()
ko.login(token="EsBs5XSLEXI4WB4KP187.eXFgWOXrI3JhMUDeNiENXW.e6NakwTaeOarHCx+cklptS3QPkeVVCDgYhdvMO8KsdU=")
ko.loginResult()

kp = LINETCR.LINE()
kp.login(token="EsVR1Otjdq9cKah9tmE8.Gmmj/LDUVq+s+BNzSshgka.4+b6bnmtAsOqxJygQy/CGPY/c5xMtj/xXKqVN6ewn+g=")
kp.loginResult()

kq = LINETCR.LINE()
kq.login(token="EsevIUHvNBfaCGwVz2r7.KqoyBq1wibhV8J45MqV+5W.olZxjEp4BHZQaJ74bgeGFOVyuZ5ozZjTcdLmcv78x3E=")
kq.loginResult()

kr = LINETCR.LINE()
kr.login(token="EsfokfHGSJvdn9sWkv42.PNmLdMI0QA4RnNb+b08veG.u38hWk7bWVtEMuthVReyZpP8rLSiFozuWdIw4O8xd14=")
kr.loginResult()

ks = LINETCR.LINE()
ks.login(token="Es9YPWZ9mZjjoq4EzOp5.7AI89wqS5I2hIsL2g968bq.zWfXcHVbGWWoF7RS/HlwcwNpAFvR48BeIN+IHfe8b+I=")
ks.loginResult()

kt = LINETCR.LINE()
kt.login(token="Es3UWKARqMBNcERdFwC8.O25e65SCFmtFgBSTyZBxMa.KrnN7+2iwwr1wbigBC/wTZe77g2OpfYujjRfP+X81Og=")
kt.loginResult()

ku = LINETCR.LINE()
ku.login(token="EsaArw8ZhgiWtmZ9tdT5.aWkoAA8etoqVcQUeSRSo1q.J5CNkl0JFe+ZMqPvXBPmaoDaPLyppH7eNoEgv+xz8Ls=")
ku.loginResult()

kv = LINETCR.LINE()
kv.login(token="EssjaqbXnHQQCJg9MWYd.JU0ytASjhRcEHviXnng+Zq.i5qiGbbpoKXQiq3zSj4J8ewa+zt9+jSDEzR1HmqeqRk=")
kv.loginResult()

kw = LINETCR.LINE()
kw.login(token="EsYuK21DC1DJ3GmyU25c.8mbU9Qs9MrmxwvuNXICTda.Gk3yCS7zPirlqVD01sUbOF2PqYoxELbEyeoL/kSLTX4=")
kw.loginResult()

kx = LINETCR.LINE()
kx.login(token="Es0DDGHU9ISWlFelZq31.tVVuNIfqBrYTb2aurxs88q.S4H0oBCojbkRldDH8LLHcJrvucAgVm2MXzhcEG25TmA=")
kx.loginResult()

ky = LINETCR.LINE()
ky.login(token="EsnLa02J9uHXnm1RZaR7.v3sqF3OksXegXM+EfPH9zW.2lRaR7NkuEKkJh0Mz3YXYJjbjVazBcwKxHXUEZxg8xc=")
ky.loginResult()

kz = LINETCR.LINE()
kz.login(token="Es3wX4d8UUyXHChHeJx6.Ys6Rt54R3uUQB5l0F2W3PG.KS/1q35c64o7a0mW7LWBly8biNJwzdvULZtAQHlPrSE=")
kz.loginResult()

kk = LINETCR.LINE()
kk.login(token="EsPIdpQon1ZU9ZmB26v0.rGm4bkvTi4OPdlfDXCAQ8a.EHpXjZolxPCZ4yMfezjeQgiDDFl9mj7POT7hbB4Qr/8=")
kk.loginResult()

sw = LINETCR.LINE()
sw.login(token="EssE5sMGr5QEdXnElZy2.WXc/TGGn50c8rn8CNUdgKG.mq2N0Tcb5AoP3Ri5vI3v9Bdn9pBB+dn1KYC5zSBa7ng=")
sw.loginResult()

kb = LINETCR.LINE()
kb.login(token="Es3U86g02oAA3F2N87U0.baD2tzkPSNo1xDUzkQbIWa.mL44Em1yEVNlS4Zyvcg4DlqHTFfVsBrlpfsP95+6RW4=")
kb.loginResult()
...
��✒ C͍͇̪̲͎̯͎̫̩̽̅̈́̅̌́̍̐ŗ̛͔̳͔̦́̋͛̎e̶̮̳͕͍̺̼̱͎͛̃̾̍̑̐ǻ͕͍̻̭̟̪͒́́̎̕͘̕͟t̢̠̻̗̠͙̦͒̉̈̎͂̐͒͑o̸̡̲̜̯̤͚̠̬͊̓̌̄̒͠r̵̺̲̗̩͙̐̇̾̐͐̏̃̓́̊ B̝̪̭͓͍̺͐͂̑̅̓͗͗̈́͢y͚͔̝͖̮̤͚̅̉̑̐̓̀̋̊͂͜͜͢͞:̶̨̻̪͓̦̻̋̾̂̽̎͘͜͜ TEGUH ��✒•┅───── """

KAC=[cl,ki,kk,kc,kd,ke,kf,kg,kh,kj,kl,km,kn,ko,kp,kq,kr,ks,kt,ku,kv,kw,kx,ky,kz,kk,sw,kb]
...
autoleaveroom = [] 
targets = [] 
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid,Umid,Vmid,Wmid,Xmid,Ymid,Zmid,Kmid,Wmid,Bmid]
admin = ["u479ac059fe16c72a87bee2d0901e8c3f",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid,Umid,Vmid,Wmid,Xmid,Ymid,Zmid,Kmid,Wmid,Bmid]
owner = ["u479ac059fe16c72a87bee2d0901e8c3f",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid,Umid,Vmid,Wmid,Xmid,Ymid,Zmid,Ymid,Zmid,Kmid,Wmid,Bmid]
wait = {
    'contact':False,
    'autoJoin':False,
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thanks for add Me MY NAME  TEGUH",
    "lang":"JP",
    "comment":"AutoLike by Teguh",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
contact = sw.getProfile()
backup = sw.getProfile()
backup.displayName = contact.displayName
backup.pictureStatus = contact.pictureStatus
        ...
        if op.type == 32:
            if not op.param2 in Bots:
                if wait["protectionOn"] == True: 
                    try:
                        klist=[ki,kk,kc,kd,ke,kf,kg,kh,kj,kn,ko,kp,kq,kr,ks,kt,ku,kv,kw,kx,ky,kz,kk,sw,kb]
        ...
        if op.type == 19:
                if not op.param2 in Bots:
                    try:
                        ...
                        gs = ku.getGroup(op.param1)
                        gs = kv.getGroup(op.param1)
                        gs = kw.getGroup(op.param1)
                        gs = kx.getGroup(op.param1)
                        gs = ky.getGroup(op.param1)
                        gs = kz.getGroup(op.param1)
                        gs = kx.getGroup(op.param1)
                        gs = sw.getGroup(op.param1)
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                klist=[kt,ks,kr,kq,kp,ko,kn,kj,kh,kg,kf,ke,kd,kc,kk,ki,cl,ku,kv,kx,ky,kz,kk,sw,kb]
                kicker = random.choice(klist)
...
#==================================================
                ...
                if msg.toType == 2:
                    klist=[kj,kh,kg,kf,ke,kd,kc,kk,ki,kn,ko,kp,kq,kr,ks,kt,ku,kv,kw,kx]
                    kicker = random.choice(klist)
				...
				cl.sendMessage(msg)
				cl.sendText(msg.to,"My Creator 👉Teguh  ")
            elif "Id" == msg.text:
                key = msg.to
			...
			kt.sendText(msg.to,Tmid)
                        ...
                        kv.sendText(msg.to,Vmid)
                        kw.sendText(msg.to,Wmid)
                        kx.sendText(msg.to,Xmid)
                        ky.sendText(msg.to,Xmid)
                        kz.sendText(msg.to,Xmid)
                        kk.sendText(msg.to,Xmid)
                        sw.sendText(msg.to,Xmid)
                        kb.sendText(msg.to,Xmid)
...
#======================================
            ...
            elif msg.text in ["Protect:on","Pt on"]:
                if wait["protectionOn"] == True:
                    if wait["lang"] == "JP":
                ...
                if wait["qr"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already on")
            elif msg.text in ["Protect:off","Pt off"]:
...
#------------------------------------------------
	           ...
	           if msg.from_ in admin:
                    ...
                    try:
                       ...
                       pass
#-----------------------------------------------
            elif msg.text in ["Bk on","Backup on"]:
                if wait["Backup"] == True:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Sudah on Bos\n\n"+ datetime.today().strftime('%H:%M:%S'))
            elif msg.text in ["Bk off","Backup off"]:
...
#========================================
            ...
            elif msg.text in ["Com on","Com:on"]:
                ...
                if msg.toType == 2:
                    ...
                    for g in group.members:
                        if _name == g.displayName:
                            targets.append(g.mid)
                    if targets == []:
                        cl.sendText(msg.to,"Ra ono wonge")
                    else:
                        for target in targets:
                            try:
                                contact = cl.getContact(target)
...
#========================================
                ...
                try:
                    ...
                    ku.updateDisplayPicture(backup.pictureStatus)
                    ku.updateProfile(backup)
                    kw.updateDisplayPicture(backup.pictureStatus)
                    kw.updateProfile(backup)
                    kx.updateDisplayPicture(backup.pictureStatus)
                    kx.updateProfile(backup)
                    ky.updateDisplayPicture(backup.pictureStatus)
                    ky.updateProfile(backup)
                    kz.updateDisplayPicture(backup.pictureStatus)
                    kz.updateProfile(backup)
                    kk.updateDisplayPicture(backup.pictureStatus)
                    kk.updateProfile(backup)
                    sw.updateDisplayPicture(backup.pictureStatus)
                    sw.updateProfile(backup)
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                          if target not in Bots:
                            try:
                                klist=[cl,ki,kk,kc,kd,ke,kf,kg,kh,kj,kn,ko,kp,kq,kr,ks,kt,ku,kv,kw,kx]
                                kicker=random.choice(klist)
...
#========================================
                ...
                ginfo = cl.getGroup(msg.to)
                cl.sendText(msg.to,"Welcome to Grup " + str(ginfo.name))
...
#========================================
            elif msg.text in ["777","Join","เข้ามา"]:
				...
				gid = kt.getGroupIdsJoined()
                                ...
                                gid = kv.getGroupIdsJoined()
                                gid = kw.getGroupIdsJoined()
				...
				for i in gid:
					...
					kt.leaveGroup(i)
                                        ...
                                        kx.leaveGroup(i)
				if wait["lang"] == "JP":
					ki.sendText(msg.to,"Pamit lur👋😂")
				else:
					ki.sendText(msg.to,"He declined all invitations")
            elif msg.text in ["999","pulang all","ไปใด้"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
...
#=============================================
                ...
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%s<==Gubraaagg" % (elapsed_time))
...
#------------------------------------------------------------------------------------
        if op.type == 32:
			OWN = "uf50d888821632d32461e37153ac775c0","u479ac059fe16c72a87bee2d0901e8c3f","u0fff0333558535e9cdbe1df7fad7e72b"
			if op.param2 in OWN:
				pass
			else:
				Inviter = op.param3.replace("",',')
